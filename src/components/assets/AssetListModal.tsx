...
const AssetListModal = ({ isOpen, assets, onClose, portfolioId, handleAddAsset }) => {
  ...
  const handleSubmit = () => {
    ...
    if (!selectedAsset || !selectedDate || isNaN(quantityAsNumber)) {
      ...
      // Le code que vous souhaitez exécuter lorsque la condition est vraie
    ...
    <>
      <Modal open={isOpen} onClose={onClose} aria-labelledby="modal-title">
        <div className="fixed inset-0 flex justify-center items-center " style={overlayStyle} onClick={onClose}>
          <Box sx={{...modalStyle, bg: 'white bg-opacity-10' }} onClick={handleModalClick}>
      ...
      <Modal open={!!selectedAsset} onClose={handleCloseAssetModal} aria-labelledby="asset-modal-title">
